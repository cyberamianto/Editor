...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div style="height: 1901px">
            <asp:ScriptManager ID="smGenerale" runat="server" />
            <asp:UpdatePanel ID="pnGenerale" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
        ...
        &nbsp;<asp:Label ID="Label1" runat="server" Text="Nominare ambiente scelto con la ddl"></asp:Label>
                    ...
                    <asp:Panel ID="pnInventarioNPC" runat="server">
                        ...
                        <asp:Image ID="imgEl2InvNPC" runat="server" style="max-height:150px;max-width:250px;height:auto;width:auto;left:320px; position:absolute;"/>
                        <asp:Image ID="imgEl3InvNPC" runat="server" style="max-height:150px;max-width:250px;height:auto;width:auto;left:640px; position:absolute;"/>
                        <asp:Image ID="imgEl4InvNPC" runat="server" style="max-height:150px;max-width:250px;height:auto;width:auto;left:960px; position:absolute;"/>
                        <asp:Image ID="imgEl5InvNPC" runat="server" style="max-height:150px;max-width:250px;height:auto;width:auto;left:1280px; position:absolute;"/>
                        <br />
                        <br />
                    </asp:Panel>
                    <br />
                    <asp:Panel ID="pnPlayer" runat="server" style="margin-bottom: 0px">
                        ...
                        <br />
                        <asp:Image ID="imgSkin" runat="server" style="max-height:150px;max-width:250px;height:auto;width:auto;left:10px; position:absolute;" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <Triggers>
                        <asp:PostBackTrigger ControlID="btnCaricaImgAmb" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl1Inv" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl2Inv" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl3Inv" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl4Inv" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl5Inv" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl1InvNPC" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl2InvNPC" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl3InvNPC" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl4InvNPC" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgEl5InvNPC" />
                        <asp:PostBackTrigger ControlID="btnCaricaImgPlayer" />
                    </Triggers>
                </asp:UpdatePanel>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
